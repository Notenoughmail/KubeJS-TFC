...
@ReturnsSelf
public class SoilDiscBuilder extends ConfiguredFeatureBuilder<SoilDiscFeature, SoilDiscConfig> {
    ...
    @Override
    public Supplier<SoilDiscFeature> feature() {
        return TFCFeatures.SOIL_DISC;
    }

    @Override
    public SoilDiscConfig createFeatureConfig() {
