...
public class KubeAnimalProductEvent implements KubePlayerEvent {

    private final AnimalProductEvent event;

    public KubeAnimalProductEvent(AnimalProductEvent event) {
        this.event = event;
    }
    ...
    public void setFluidProduct(FluidStack fluid) {
        event.setProduct(fluid);
    }
