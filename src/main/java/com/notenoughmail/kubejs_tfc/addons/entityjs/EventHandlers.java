...
import com.notenoughmail.kubejs_tfc.addons.entityjs.builders.IHaveFaunaDefinition;
...
public class EventHandlers {
    ...
    public static void init() {
        ...
        modBus.addListener(EventHandlers::spawnPlacement);
    }

    private static void spawnPlacement(SpawnPlacementRegisterEvent event) {
        for (IHaveFaunaDefinition.FaunaType<?> type : IHaveFaunaDefinition.registeredFaunas) {
