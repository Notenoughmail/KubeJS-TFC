...
public class ProsDrillItemBuilder extends PropickItemBuilder {

    public ProsDrillItemBuilder(ResourceLocation i) {
        super(i);
    }

    @Override
    public Item createObject() {
        return new ProsDrillItem(toolTier, attackDamageBaseline, speedBaseline, createItemProperties()) {
