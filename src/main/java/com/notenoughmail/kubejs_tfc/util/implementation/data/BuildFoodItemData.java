...
public class BuildFoodItemData {
    ...
    @Info("Sets the food definition to be a special type, either 'dynamic', or 'dynamic_bowl'. If set, none of the other values should be set")
    public BuildFoodItemData type(String type) {
        this.type = type;
        return this;
    }

    @Info("Sets how much hunger this food restores, defaults to 4. A full hunger bar is equal to 20")
    public BuildFoodItemData hunger(int hunger) {
        this.hunger = hunger;
        return this;
    }

    @Info("Sets how much saturation this food restores, defaults to 0")
    public BuildFoodItemData saturation(float saturation) {
        this.saturation = saturation;
        return this;
    }

    @Info("Sets how much water this food restores, defaults to 0. A full water bar is equal to 100")
    public BuildFoodItemData water(float water) {
        this.water = water;
        return this;
    }

    @Info("Sets how quickly this food decays, defaults to 1. A higher number indicates a faster decay value")
    public BuildFoodItemData decayModifier(float modifier) {
        decay = modifier;
        return this;
    }

    @Info("Sets how much grain nutrient this food restores, defaults to 0")
    public BuildFoodItemData grain(float grain) {
        this.grain = grain;
        return this;
    }

    @Info("Sets how much fruit nutrient this food restores, defaults to 0")
    public BuildFoodItemData fruit(float fruit) {
        this.fruit = fruit;
        return this;
    }

    @Info("Sets how much vegetables nutrient this food restores, defaults to 0")
    public BuildFoodItemData vegetables(float vegetables) {
        this.vegetables = vegetables;
        return this;
    }

    @Info("Sets how much protein nutrient this food restores, defaults to 0")
    public BuildFoodItemData protein(float protein) {
        this.protein = protein;
        return this;
    }

    @Info("Sets how much dairy nutrient this food restores, defaults to 0")
