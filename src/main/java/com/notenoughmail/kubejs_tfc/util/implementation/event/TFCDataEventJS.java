...
public class TFCDataEventJS extends DataPackEventJS {
    ...
    public void addTFCEntityDamageResistance(String entityTag, @Nullable Integer piercing, @Nullable Integer slashing, @Nullable Integer crushing) {
        final JsonObject json = new JsonObject();
    ...
    public void addTFCFertilizer(Ingredient ingredient, @Nullable Number nitrogen, @Nullable Number phosphorous, @Nullable Number potassium) {
        final JsonObject json = new JsonObject();
        json.add("ingredient", ingredient.toJson());
    ...
    public void addTFCItemSize(Ingredient ingredient, @Nullable Size size, @Nullable Weight weight) {
        final JsonObject json = new JsonObject();
        json.add("ingredient", ingredient.toJson());
    ...
    public void addKnappingType(Ingredient ingredient, int ingredientCount, int amountToConsume, ResourceLocation clickSound, boolean consumeAfterComplete, boolean useDisabledTexture, boolean spawnsParticles, ItemStack jeiIconItem) {
        ...
        addJson(DataUtils.dataIDFromObject(ingredient, "tfc", "knapping_types"), json);
    }
    ...
    public void addKnappingType(Ingredient ingredient, int ingredientCount, int amountToConsume, ResourceLocation clickSound, boolean consumeAfterComplete, boolean useDisabledTexture, boolean spawnsParticles, ItemStack jeiIconItem, ResourceLocation name) {
        final JsonObject json = DataUtils.knappingType(ingredient, ingredientCount, amountToConsume, clickSound, consumeAfterComplete, useDisabledTexture, spawnsParticles, jeiIconItem);
    ...
    @Info(value = "Adds a sluicing definition to the ingredient", params = {
            @Param(name = "ingredient", value = "The ingredient the definition applies to"),
            @Param(name = "lootTable", value = "The name of a loot table to be dropped by the ingredient")
    })
    ...
    @Info(value = "Adds a panning definition to the blokc ingredient", params = {
            @Param(name = "blockIngredient", value = "The block ingredient the definition applies to"),
            @Param(name = "lootTable", value = "The name of a loot table to be dropped by the ingredient"),
            @Param(name = "models", value = "A list of model locations to be iterated through as panning progresses"),
